...
const contactMethods = [
  {
    ...
    contact: "Old Lesotho Housing (Leap Office)",
    title: "Our office",
  },
  {
    icon: (
  ...
  },
  {
    ...
    contact: "ask@medialabnetwork.com",
    title: "Email",
  },
];
          ...
          <ul className="mt-12 grid grid-cols-1 gap-12 md:grid-cols-3">
            {contactMethods.map((item, idx) => (
              <li key={idx} className="flex flex-col items-center">
                <div className="flex-none text-gray-400 mb-2">{item.icon}</div>
                <h4 className="dark:text-white-500 text-lg font-medium">
                  {item.title}
                </h4>
